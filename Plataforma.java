...
public class Plataforma {
    ...
    public void menuprincipal() {
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 7:
                    cantidadporrangodepeso();
                    break;

                case 8:
                    listadepacientesordenados();
                    break;

                case 9:
                    medicoqueatendiopordni();
                    break;
    ...
    private void cantidadporrangodepeso() {
        if (ListaPacientes.isEmpty()) {
            System.out.println("No hay pacientes registrados.");
            return;
        }
    ...
    private void listadepacientesordenados() {
    ...
    private void medicoqueatendiopordni() {
        Scanner scanner = new Scanner(System.in);
    ...
    private void doctoresporespecialidad() {
        Scanner scanner = new Scanner(System.in);
